...
The Seed module provides seed node functionality for the JMDT network. It enables nodes to operate as seed nodes for peer discovery and registration, managing peer registries and providing peer information to network participants.
