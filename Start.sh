...
start_daemon() {
    ...
    JMDN_CMD="./jmdn -heartbeat 10 -api 8090 -blockgen 15050 -did localhost:15052 -cli 15053 -seednode 34.174.233.203:17002 -facade 8545 -ws 8546 -chainID 7000700 -metrics 8082"
