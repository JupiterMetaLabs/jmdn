...
type CatchUpRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Peer          string                 `protobuf:"bytes,1,opt,name=peer,proto3" json:"peer,omitempty"`                             // full libp2p multiaddr with peer ID
	FromBlock     uint64                 `protobuf:"varint,2,opt,name=from_block,json=fromBlock,proto3" json:"from_block,omitempty"` // first block NOT in local DB (bootstrap tip + 1)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CatchUpRequest) GetPeer() string {
	if x != nil {
		return x.Peer
	}
	return ""
...
func (x *CatchUpRequest) GetFromBlock() uint64 {
	if x != nil {
		return x.FromBlock
	}
	return 0
...
func (x *CleanPeersResponse) Reset() {
	*x = CleanPeersResponse{}
	mi := &file_Connection_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CleanPeersResponse) Descriptor() ([]byte, []int) {
	return file_Connection_proto_rawDescGZIP(), []int{19}
}
...
func (x *DatabaseStates) Reset() {
	*x = DatabaseStates{}
	mi := &file_Connection_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DatabaseStates) Descriptor() ([]byte, []int) {
	return file_Connection_proto_rawDescGZIP(), []int{20}
}
...
type TxIndexRebuildRangeRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *TxIndexRebuildRangeRequest) Reset() {
	*x = TxIndexRebuildRangeRequest{}
	mi := &file_Connection_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TxIndexRebuildRangeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TxIndexRebuildRangeRequest) ProtoMessage() {}

func (x *TxIndexRebuildRangeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_Connection_proto_msgTypes[21]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TxIndexRebuildRangeRequest.ProtoReflect.Descriptor instead.
func (*TxIndexRebuildRangeRequest) Descriptor() ([]byte, []int) {
	return file_Connection_proto_rawDescGZIP(), []int{21}
}

func (x *TxIndexRebuildRangeRequest) GetFromBlock() uint64 {
	if x != nil {
		return x.FromBlock
	}
	return 0
...
func (x *TxIndexRebuildRangeRequest) GetToBlock() uint64 {
	if x != nil {
		return x.ToBlock
	}
	return 0
...
type TxIndexRebuildResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TimeTakenMs   int64                  `protobuf:"varint,1,opt,name=time_taken_ms,json=timeTakenMs,proto3" json:"time_taken_ms,omitempty"` // wall-clock duration of the rebuild, in milliseconds
	Error         string                 `protobuf:"bytes,2,opt,name=error,proto3" json:"error,omitempty"`                                   // empty on success
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *TxIndexRebuildResponse) Reset() {
	*x = TxIndexRebuildResponse{}
	mi := &file_Connection_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TxIndexRebuildResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TxIndexRebuildResponse) ProtoMessage() {}

func (x *TxIndexRebuildResponse) ProtoReflect() protoreflect.Message {
	mi := &file_Connection_proto_msgTypes[22]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TxIndexRebuildResponse.ProtoReflect.Descriptor instead.
func (*TxIndexRebuildResponse) Descriptor() ([]byte, []int) {
	return file_Connection_proto_rawDescGZIP(), []int{22}
}

func (x *TxIndexRebuildResponse) GetTimeTakenMs() int64 {
	if x != nil {
...
func (x *TxIndexRebuildResponse) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
type TxIndexStatusResponse struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	Ready            bool                   `protobuf:"varint,1,opt,name=ready,proto3" json:"ready,omitempty"`                                                 // false while the initial/rebuild catchup is still in progress
	LastIndexedBlock uint64                 `protobuf:"varint,2,opt,name=last_indexed_block,json=lastIndexedBlock,proto3" json:"last_indexed_block,omitempty"` // highest block number fully indexed so far
	Error            string                 `protobuf:"bytes,3,opt,name=error,proto3" json:"error,omitempty"`                                                  // empty on success (e.g. "txindex not initialised" otherwise)
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}

func (x *TxIndexStatusResponse) Reset() {
	*x = TxIndexStatusResponse{}
	mi := &file_Connection_proto_msgTypes[23]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TxIndexStatusResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TxIndexStatusResponse) ProtoMessage() {}

func (x *TxIndexStatusResponse) ProtoReflect() protoreflect.Message {
	mi := &file_Connection_proto_msgTypes[23]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TxIndexStatusResponse.ProtoReflect.Descriptor instead.
func (*TxIndexStatusResponse) Descriptor() ([]byte, []int) {
	return file_Connection_proto_rawDescGZIP(), []int{23}
}

func (x *TxIndexStatusResponse) GetReady() bool {
	if x != nil {
		return x.Ready
	}
	return false
...
func (x *TxIndexStatusResponse) GetLastIndexedBlock() uint64 {
	if x != nil {
		return x.LastIndexedBlock
	}
	return 0
}

func (x *TxIndexStatusResponse) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
const file_Connection_proto_rawDesc = "" +
	...
	"accountsDb\"V\n" +
	"\x1aTxIndexRebuildRangeRequest\x12\x1d\n" +
	"\n" +
	"from_block\x18\x01 \x01(\x04R\tfromBlock\x12\x19\n" +
	"\bto_block\x18\x02 \x01(\x04R\atoBlock\"R\n" +
	"\x16TxIndexRebuildResponse\x12\"\n" +
	"\rtime_taken_ms\x18\x01 \x01(\x03R\vtimeTakenMs\x12\x14\n" +
	"\x05error\x18\x02 \x01(\tR\x05error\"q\n" +
	"\x15TxIndexStatusResponse\x12\x14\n" +
	"\x05ready\x18\x01 \x01(\bR\x05ready\x12,\n" +
	"\x12last_indexed_block\x18\x02 \x01(\x04R\x10lastIndexedBlock\x12\x14\n" +
	"\x05error\x18\x03 \x01(\tR\x05error2\xbe\f\n" +
	"\n" +
	"CLIService\x124\n" +
	...
	"\x10GetDatabaseState\x12\x16.google.protobuf.Empty\x1a\x13.cli.DatabaseStates\"\x00\x12G\n" +
	"\x0eRebuildTxIndex\x12\x16.google.protobuf.Empty\x1a\x1b.cli.TxIndexRebuildResponse\"\x00\x12U\n" +
	"\x13RebuildTxIndexRange\x12\x1f.cli.TxIndexRebuildRangeRequest\x1a\x1b.cli.TxIndexRebuildResponse\"\x00\x12H\n" +
	"\x10GetTxIndexStatus\x12\x16.google.protobuf.Empty\x1a\x1a.cli.TxIndexStatusResponse\"\x00\x123\n" +
...
var file_Connection_proto_goTypes = []any{
	...
	(*FirstSyncRequest)(nil),           // 13: cli.FirstSyncRequest
	(*CatchUpRequest)(nil),             // 14: cli.CatchUpRequest
	(*SyncInfo)(nil),                   // 15: cli.SyncInfo
	(*GethStatus)(nil),                 // 16: cli.GethStatus
	(*AliasList)(nil),                  // 17: cli.AliasList
	(*OperationResponse)(nil),          // 18: cli.OperationResponse
	(*CleanPeersResponse)(nil),         // 19: cli.CleanPeersResponse
	(*DatabaseStates)(nil),             // 20: cli.DatabaseStates
	(*TxIndexRebuildRangeRequest)(nil), // 21: cli.TxIndexRebuildRangeRequest
	(*TxIndexRebuildResponse)(nil),     // 22: cli.TxIndexRebuildResponse
	(*TxIndexStatusResponse)(nil),      // 23: cli.TxIndexStatusResponse
	(*timestamppb.Timestamp)(nil),      // 24: google.protobuf.Timestamp
	(*emptypb.Empty)(nil),              // 25: google.protobuf.Empty
}
var file_Connection_proto_depIdxs = []int32{
	0,  // 0: cli.PeerList.peers:type_name -> cli.Peer
	24, // 1: cli.DIDDocument.created_at:type_name -> google.protobuf.Timestamp
	24, // 2: cli.DIDDocument.updated_at:type_name -> google.protobuf.Timestamp
	...
	25, // 7: cli.CLIService.ListPeers:input_type -> google.protobuf.Empty
	8,  // 8: cli.CLIService.AddPeer:input_type -> cli.PeerRequest
	8,  // 9: cli.CLIService.RemovePeer:input_type -> cli.PeerRequest
	25, // 10: cli.CLIService.CleanPeers:input_type -> google.protobuf.Empty
	...
	25, // 15: cli.CLIService.GetMessageStats:input_type -> google.protobuf.Empty
	...
	8,  // 19: cli.CLIService.FastSyncV2:input_type -> cli.PeerRequest
	8,  // 20: cli.CLIService.AccountSync:input_type -> cli.PeerRequest
	13, // 21: cli.CLIService.FirstSync:input_type -> cli.FirstSyncRequest
	14, // 22: cli.CLIService.CatchUpSync:input_type -> cli.CatchUpRequest
	25, // 23: cli.CLIService.GetDatabaseState:input_type -> google.protobuf.Empty
	25, // 24: cli.CLIService.RebuildTxIndex:input_type -> google.protobuf.Empty
	21, // 25: cli.CLIService.RebuildTxIndexRange:input_type -> cli.TxIndexRebuildRangeRequest
	25, // 26: cli.CLIService.GetTxIndexStatus:input_type -> google.protobuf.Empty
	25, // 27: cli.CLIService.ReturnAddrs:input_type -> google.protobuf.Empty
	25, // 28: cli.CLIService.GetSyncInfo:input_type -> google.protobuf.Empty
	25, // 29: cli.CLIService.GetGethStatus:input_type -> google.protobuf.Empty
	25, // 30: cli.CLIService.DiscoverNeighbors:input_type -> google.protobuf.Empty
	25, // 31: cli.CLIService.ListAliases:input_type -> google.protobuf.Empty
	25, // 32: cli.CLIService.GetNodeVersion:input_type -> google.protobuf.Empty
	1,  // 33: cli.CLIService.ListPeers:output_type -> cli.PeerList
	18, // 34: cli.CLIService.AddPeer:output_type -> cli.OperationResponse
	18, // 35: cli.CLIService.RemovePeer:output_type -> cli.OperationResponse
	19, // 36: cli.CLIService.CleanPeers:output_type -> cli.CleanPeersResponse
	18, // 37: cli.CLIService.SendMessage:output_type -> cli.OperationResponse
	18, // 38: cli.CLIService.SendYggdrasilMessage:output_type -> cli.OperationResponse
	18, // 39: cli.CLIService.SendFile:output_type -> cli.OperationResponse
	18, // 40: cli.CLIService.BroadcastMessage:output_type -> cli.OperationResponse
	2,  // 41: cli.CLIService.GetMessageStats:output_type -> cli.MessageStats
	4,  // 42: cli.CLIService.GetDID:output_type -> cli.DIDDocument
	18, // 43: cli.CLIService.PropagateDID:output_type -> cli.OperationResponse
	5,  // 44: cli.CLIService.FastSync:output_type -> cli.SyncStats
	5,  // 45: cli.CLIService.FastSyncV2:output_type -> cli.SyncStats
	5,  // 46: cli.CLIService.AccountSync:output_type -> cli.SyncStats
	5,  // 47: cli.CLIService.FirstSync:output_type -> cli.SyncStats
	5,  // 48: cli.CLIService.CatchUpSync:output_type -> cli.SyncStats
	20, // 49: cli.CLIService.GetDatabaseState:output_type -> cli.DatabaseStates
	22, // 50: cli.CLIService.RebuildTxIndex:output_type -> cli.TxIndexRebuildResponse
	22, // 51: cli.CLIService.RebuildTxIndexRange:output_type -> cli.TxIndexRebuildResponse
	23, // 52: cli.CLIService.GetTxIndexStatus:output_type -> cli.TxIndexStatusResponse
	6,  // 53: cli.CLIService.ReturnAddrs:output_type -> cli.Addrs
	15, // 54: cli.CLIService.GetSyncInfo:output_type -> cli.SyncInfo
	16, // 55: cli.CLIService.GetGethStatus:output_type -> cli.GethStatus
	18, // 56: cli.CLIService.DiscoverNeighbors:output_type -> cli.OperationResponse
	17, // 57: cli.CLIService.ListAliases:output_type -> cli.AliasList
	7,  // 58: cli.CLIService.GetNodeVersion:output_type -> cli.VersionInfo
