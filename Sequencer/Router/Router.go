...
func (r *Router) HandleVerifySubscription(logger_ctx context.Context, gossipMessage *PubSubMessages.GossipMessage) error {
	if r.verificationService == nil {
		return fmt.Errorf("verification service not initialized")
	}

	return r.verificationService.HandleVerifySubscription(logger_ctx, gossipMessage)
}

// VerifySubscriptions routes bulk subscription verification
func (r *Router) VerifySubscriptions(logger_ctx context.Context, expectedPeers []peer.ID, timeout time.Duration) (map[peer.ID]string, error) {
	if r.verificationService == nil {
		return nil, fmt.Errorf("verification service not initialized")
	}

	return r.verificationService.VerifySubscriptions(logger_ctx, expectedPeers, timeout)
}
...
func (r *Router) SendVerificationResponse(logger_ctx context.Context, accepted bool) error {
	if r.verificationService == nil {
		return fmt.Errorf("verification service not initialized")
	}

	return r.verificationService.SendVerificationResponse(logger_ctx, accepted)
}
...
func (r *Router) RouteMessage(logger_ctx context.Context, gossipMessage *PubSubMessages.GossipMessage) error {
	...
	case "Type_VerifySubscription":
		return r.HandleVerifySubscription(logger_ctx, gossipMessage)
	default:
...
func (r *Router) ProcessVerificationRequest(logger_ctx context.Context, gossipMessage *PubSubMessages.GossipMessage) error {
	...
	return r.RouteMessage(logger_ctx, gossipMessage)
}
...
func (r *Router) ProcessCompleteVerification(logger_ctx context.Context, gossipMessage *PubSubMessages.GossipMessage) error {
	...
	return r.ProcessVerificationRequest(logger_ctx, gossipMessage)
}
...
func (r *Router) SendVerificationResponseWithValidation(logger_ctx context.Context, accepted bool) error {
	if r.verificationService == nil {
		return fmt.Errorf("verification service not initialized")
	}
	...
	return r.SendVerificationResponse(logger_ctx, accepted)
}
