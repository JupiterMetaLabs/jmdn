...
The Sequencer module provides consensus orchestration for the JMDT network. It manages buddy node selection, consensus initiation, vote collection, and BFT consensus execution.
