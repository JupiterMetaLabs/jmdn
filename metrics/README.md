...
The Metrics module provides Prometheus-compatible metrics collection for the JMDT network. It tracks system performance, peer connections, message statistics, and database operations.
