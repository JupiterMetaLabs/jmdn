...
The Messaging module provides peer-to-peer communication capabilities for the JMZK network. It handles message propagation, block broadcasting, DID propagation, and direct messaging via libp2p and Yggdrasil.
